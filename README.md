...
# 実行（例：最初の50フレームのみ）
cargo run -- --api-key "..." --max-frames 50 --output-dir ./out res/arc-timeline-daily.0007-10-25.gpx
```
...
```bash
cargo run -- --api-key "..." --output-dir ./out res/arc-timeline-daily.0007-10-25.gpx
```
